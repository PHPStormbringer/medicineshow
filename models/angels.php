...
class angels
{
	...
	public static $str_TableName = "angels";
    ...
    public static function get_last_record()
	{
        ...
        $query = "SELECT * FROM `angels` order by uid desc limit 1";
	...
	public static function get_active_records()
	{
        ...
        $result = db_get::QUERY($con, "SELECT * FROM `angels` WHERE actv = 1 ORDER BY rank");
	...
	public static function insert_record(angels $cherub)
	{
        $con = db_get::get_connection();
        	
		$query = "INSERT INTO `angels` (name, desc, actv, rank) VALUES ('".$cherub->name."','".$cherub->desc."','".$cherub->actv."',".$cherub->rank."')";
	...
	{
        $con = db_get::get_connection();
        $query = "UPDATE `angels` SET name = '$cherub->name', desc = '$cherub->desc', actv = '$cherub->actv', rank = '$cherub->rank' WHERE uid = '$cherub->uid'";
	...
	public static function delete_record($int_pid)
	{
		...
		$query = "DELETE FROM `angels` WHERE uid = $int_pid";
