...
class m_productions
{
	...
	public static function get_column_names()
	{
	    ...
	    if(self::$pid){ $query = "SELECT * FROM productions WHERE id = " . self::$pid; }
            ...
            $query = "SELECT * FROM show_pics WHERE show_id = ".self::$pid;
	...
	public static function get_all_mainstage_records()
	{
		$con = db_get::get_connection();

		$query = "SELECT * FROM productions WHERE stage = '1 - Main Stage Production' ORDER BY season ASC";
		$result = db_get::QUERY($con, $query);
	...
	public static function get_all_mainstage_records_by_season()
	{
		$con = db_get::get_connection();

		$query = "SELECT * FROM productions WHERE stage = '1 - Main Stage Production' ORDER BY season DESC";
		$result = db_get::QUERY($con, $query);
