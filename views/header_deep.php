...
<?php
echo "<div style='width:100px;'><a href='../home'>home</a></div>";
echo "<div style='width:100px;'><a href='../aboutus'>aboutus</a></div>";
echo "<div style='width:100px;'><a href='../angels'>angels</a></div>";
echo "<div style='width:100px;'><a href='../contactus'>contact us</a></div>";

echo "<div style='width:100px;'><a href='../history'>history</a></div>";
echo "<div style='width:100px;'><a href='../jumpstart'>jumpstart</a></div>";

echo "<div style='width:100px;'><a href='../rentals'>rentals</a></div>";

echo "<div style='width:100px;'><a href='../workshops'>workshops</a></div>";
echo "<div style='width:100px;'><a href='../wordplay'>wordplay</a></div>";


echo "<div style='width:100px;'><a href='../artists/?name=chrisbrandt'>Chris Brandt</a></div>";
